...
Objective: Classify materials based on sales revenue contribution to prioritize high-value inventory items.

3.	Working Capital Optimization (EOQ & Inventory Turnover).
Objective: Calculate the Economic Order Quantity (EOQ) and inventory turnover ratios to optimize holding costs and balance inventory coverage.

4.	Automated Restock Alert & Sustainable Inventory Strategy.
Objective: Provide a dynamic triggering system for critical stock replenishment and flag overstock items to protect working capital.
